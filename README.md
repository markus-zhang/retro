...
I was a little worried about the spaces, but apparently it was in 198x and people took it seriously. The whole installation took less than 2MB.
...
For cross compilation, it is a bit complicated. I use OpenWatcom 2.0, and you can refer my link scripts and build.ps1 file for details. You should be able to drop them in directly, but remember to change the directory of OpenWatcom to your own -- that is line 9 in build.ps1. You should also change the name of the asm file in line 31, and optionally you can also change the name of the executable file in the .lnk files.
